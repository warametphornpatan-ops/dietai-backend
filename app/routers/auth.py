...
def register(user: schemas.UserCreate, db: Session = Depends(get_db)):
    ...
    a = float(calculate_age(birth_date_val)) if birth_date_val else 0
...
def update_user_profile(
    ...
    a = float(calculate_age(current_user.birth_date)) if current_user.birth_date else 0
